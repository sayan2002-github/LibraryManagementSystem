...
#### IDE - NetBeans
#### Database - MYSQL
#### Connector version used - mysql-connector-j-8.0.31.jar
...
6. Right click on my component, go to pallete manager, add from jar go to the dependencies folder in this repo, select RSCalendar.jar, RSFoto_v1.0.jar and RojeruSan.parte1.jar and add to my component (this jar files contain text field and buttons that are used in this project)
